...
if __name__ == "__main__":
    ...
    for i in range(Q_board.shape[0]):
        for j in range(Q_board.shape[1]):
            ax[0,1].text(j, i, f'{Q_board[i, j]:.1f}', ha='center', va='center', color='k', fontsize=16)
    ...
    for i in range(Q_board_rotated.shape[0]):
        for j in range(Q_board_rotated.shape[1]):
            ax[1,1].text(j, i, f'{Q_board_rotated[i, j]:.1f}', ha='center', va='center', color='k', fontsize=16)
    ...
    for i in range(random_noise.shape[0]):
        for j in range(random_noise.shape[1]):
            ax[0,2].text(j, i, f'{random_noise[i, j]:.2f}', ha='center', va='center', color='k', fontsize=16)
    ...
    for i in range(random_noise_rotated.shape[0]):
        for j in range(random_noise_rotated.shape[1]):
            ax[1,2].text(j, i, f'{random_noise_rotated[i, j]:.2f}', ha='center', va='center', color='k', fontsize=16)
