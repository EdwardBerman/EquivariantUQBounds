...
ax[1,0].axvline(mean, color='blue', linestyle='--', label=f'Mean {mean:.2f}')
ax[1,0].axvline(median, color='blue', linestyle='-.', label=f'Median {median:.2f}')
...
ax[1,0].axvline(mean, color='red', linestyle='--', label=f'Mean {mean:.2f}')
ax[1,0].axvline(median, color='red', linestyle='-.', label=f'Median {median:.2f}')
...
ax[1,1].axvline(mean, color='blue', linestyle='--', label=f'Mean {mean:.2f}')
ax[1,1].axvline(median, color='blue', linestyle='-.', label=f'Median {median:.2f}')
...
ax[1,1].axvline(mean, color='red', linestyle='--', label=f'Mean {mean:.2f}')
ax[1,1].axvline(median, color='red', linestyle='-.', label=f'Median {median:.2f}')
...
baseline_aleatoric_uncertainty = np.load('../data/aleatoric_uqs_gnn_2.npy')
equivariant_aleatoric_uncertainty = np.load('../data/aleatoric_uqs_egnn_2.npy')

baseline_epistemic_uncertainty = np.load('../data/epistemic_uqs_gnn_2.npy')
equivariant_epistemic_uncertainty = np.load('../data/epistemic_uqs_egnn_2.npy')

baseline_targets = np.load('../data/targets_gnn_2.npy')
equivariant_targets = np.load('../data/targets_egnn_2.npy')

baseline_predictions = np.load('../data/preds_gnn_2.npy')
equivariant_predictions = np.load('../data/preds_egnn_2.npy')
...
ax[0,0].plot(sorted_baseline_targets, sorted_baseline_targets, color='black', linestyle='--', label='Perfect Prediction', alpha=0.33)
ax[0,0].legend(fontsize=8)
ax[0,0].set_xlabel(r'$\varepsilon_{\rm HOMO}$ Predict (eV)')
ax[0,0].set_ylabel(r'$\varepsilon_{\rm HOMO}$ Label (eV)')
...
plt.savefig('../assets/uq_bleed_epsilon_homo.pdf')

plt.close()

baseline_aleatoric_uncertainty = np.load('../data/aleatoric_uqs_gnn_4.npy')
equivariant_aleatoric_uncertainty = np.load('../data/aleatoric_uqs_egnn_4.npy')

baseline_epistemic_uncertainty = np.load('../data/epistemic_uqs_gnn_4.npy')
equivariant_epistemic_uncertainty = np.load('../data/epistemic_uqs_egnn_4.npy')

baseline_targets = np.load('../data/targets_gnn_4.npy')
equivariant_targets = np.load('../data/targets_egnn_4.npy')

baseline_predictions = np.load('../data/preds_gnn_4.npy')
equivariant_predictions = np.load('../data/preds_egnn_4.npy')
...
ax[0,0].plot(sorted_baseline_targets, sorted_baseline_targets, color='black', linestyle='--', label='Perfect Prediction', alpha=0.33)
ax[0,0].legend(fontsize=8)
ax[0,0].set_xlabel(r'$\Delta \varepsilon$ Predict (eV)')
ax[0,0].set_ylabel(r'$\Delta \varepsilon$ Label (eV)')
...
plt.savefig('../assets/uq_bleed_delta_epsilon.pdf')

plt.close()

baseline_aleatoric_uncertainty = np.load('../data/aleatoric_uqs_gnn_6.npy')
equivariant_aleatoric_uncertainty = np.load('../data/aleatoric_uqs_egnn_6.npy')

baseline_epistemic_uncertainty = np.load('../data/epistemic_uqs_gnn_6.npy')
equivariant_epistemic_uncertainty = np.load('../data/epistemic_uqs_egnn_6.npy')

baseline_targets = np.load('../data/targets_gnn_6.npy')
equivariant_targets = np.load('../data/targets_egnn_6.npy')

baseline_predictions = np.load('../data/preds_gnn_6.npy')
equivariant_predictions = np.load('../data/preds_egnn_6.npy')
...
ax[0,0].plot(sorted_baseline_targets, sorted_baseline_targets, color='black', linestyle='--', label='Perfect Prediction', alpha=0.33)
ax[0,0].legend(fontsize=8)
ax[0,0].set_xlabel('ZPVE Predict (eV)')
ax[0,0].set_ylabel('ZPVE Label (eV)')
...
plt.savefig('../assets/uq_bleed_zpve.pdf')
